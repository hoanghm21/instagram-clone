...
<template>
    ...
    <MainLayout>
        ...
        <div class="max-w-[880px] lg:ml-0 md:ml-[80px] 
            md:pl-20 px-4 w-[100vw]">
            <div class="flex items-center md:justify-between">

                <label for="fileUser">
                    <img src="https://picsum.photos/id/50/200/200"
                        class="rounded-full object-fit md:w-[200px] w-[100px]
                        cursor-pointer">
                </label>
                <input 
                    type="file" 
                ...
                <div class="ml-6 w-full">
                    ...
                    <div class="md:block hidden">
                        <div class="flex item-center text-[18px]">
                            <div class="mr-6">
        ...
        <div class="md:hidden">
            <div class="
                ...
                border-t border-t-gray-300 mt-8"
            >
                ...
                <div class="text-center p-3">
                    <div class="font-extrabold">456</div>
            ...
            <div class="md:block mt-10 hidden border-t border-t-gray-300">
                <div class="flex items-center justify-between max-w-[600px] mx-auto font-extrabold text-gray-400 text-[15px]">
                    <div class="p-[17px] w-1/4 flex justify-center items-center border-t border-t-gray-900">
                        <Grid :size="15" fillColor="#000" class="cursor-pointer" />
