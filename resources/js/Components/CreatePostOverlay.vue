...
<template>
    <div id="OverlaySection"
        class="fixed z-50 top-0 left-0 w-full h-screen
            bg-[#000] bg-opacity-60 p-3">
        ...
        <div class="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="flex items-center justify-between w-full rounded-t-xl p-3 
            ...
            <div class="w-full md:flex h-[calc(100%-55px)] rounded-xl overflow-auto">
                <div class="flex items-center bg-gray-100 w-full h-full overflow-hidden">
                    <div v-if="!fileDisplay" class="flex flex-col items-center mx-auto">
                        <label for="file"
                            class="hover:bg-blue-700 bg-blue-500 rounded-lg p-2.5 text-white
                ...
                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    ...
                    <div v-if="error && error.file" class="text-red-500 p-2 font-extrabold">
                        {{ error.file }}
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 border-b">
                        <div class="text-lg font-extrabold text-gray-500">Accessability</div>
                        <ChevronDown :size="27" />
                    </div>
                    ...
                    <div class="text-sm mt-3 p-3 text-gray-500">
