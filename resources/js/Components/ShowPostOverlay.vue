...
<template>
    <div id="OverlaySection" class="fixed z-50 top-0 left-0 w-full h-screen bg-[#000] bg-opacity-60 p-3">
        ...
        <div class="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                <div class="flex items-center bg-black w-full">
                    <img
                        :src="post.file"
                        class="rounded-xl min-w-[400px] p-4 mx-auto max-w-[476px]">
                </div>
                ...
                <div class="md:max-w-[500px] w-full relative">
                    ...
                    <div class="absolute flex border bottom-0 w-full max-h-[200px] 
                        bg-white overflow-auto">
                        <EmoticonHappyOutline class="pl-3 pt-[10px]" :size="30" />
                        <textarea ref="textare" :oninput="textareaInput"
                            v-model="comment"
