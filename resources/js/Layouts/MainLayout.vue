    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome" class="fixed z-30 md:hidden block w-full bg-white h-[61px] border-b border-b-gray-300">
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                    <img src="/insta-logo.png" alt="Instagram logo" class="w-[105px] ml-6 cursor-pointer">
                </Link>
        ...
        <div
            ...
            class="
                ...
                fixed flex 
                items-center 
                justify-between z-30 w-full 
                bg-white h-[61px] border-b 
                border-b-gray-300"
            >
        ...
        <div id="SideNav" class="
                ...
                md:block
                hidden
                bg-white w-[80px] border-r
                border-r-gray-300">
            <Link href="/">
                <img src="/insta-logo-small.png" alt="Instagram logo small" class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 cursor-pointer">
                <img src="/insta-logo.png" alt="Instagram logo" class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 cursor-pointer">
            </Link>
        ...
        <div class="flex lg:justify-between bg-white h-full w-[100%-280px] xl:pl-[280px] lg:pl-[100px] overflow-auto">
            ...
            <div v-if="$page.url === '/'" id="SuggestionsSelection" class="lg:w-4/12 lg:block hidden text-black mt-10">
                <Link :href="route('users.show', { id: $page.props.auth.user.id })" class="flex items-center justify-between max-w-[300px]">
                    <div class="flex items-center">
                        ...
                        <div class="pl-4">
                            ...
                            <div class="text-gray-500 text-extrabold text-sm">{{ $page.props.auth.user.file }}</div>
                        </div>
                    </div>
                ...
                <div class="max-w-[300px] mt-5">
                    <div class="text-sm text-gray-400">Meta
                        About
                        Blog
                        Jobs
                        Help
        ...
        <div id="bottomNav" class="fixed z-30 bottom-0 md:hidden w-full flex items-center justify-around bg-white py-2 border-t border-t-gray-300">
            <Link href="/">
            ...
            <AccountOutline fillColor="#000" :size="33" class="cursor-pointer" />
            <Link :href="route('users.show', { id: $page.props.auth.user.id })">
                <img
